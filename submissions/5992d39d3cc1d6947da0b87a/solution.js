    ...
    for (let y = 0; y < screen.length; y++) {
        for (let x = 0; x < screen[y].length; x++) {
            if (screen[y][x] == '/' || screen[y][x] == '|' || screen[y][x] == '\\' || screen[y][x] == '-')//butterfly
            {
                ...
                if (x <= screen.length[0] - 2) bitMap[y][x + 2] = 0;
            }
            if (screen[y][x] == 'O')//stone
            {
                ...
                else if (screen[y - 1][x] == '*' && screen[y - 1][x - 1] == ' ' && screen[y][x - 1] == ' ') {
                    bitMap[y][x - 1] = 0;
                }
                else if (screen[y - 1][x] == 'O' && screen[y - 1][x + 1] == ' ' && screen[y][x + 1] == ' ') {
                    bitMap[y][x + 1] = 0;
                }
                else if (screen[y - 1][x] == '*' && screen[y - 1][x + 1] == ' ' && screen[y][x + 1] == ' ') {
                    bitMap[y][x + 1] = 0;
            ...
            if (result.length) {
                ...
                switch (move) {
                    ...
                    case -2:
                        ...
                        break;
                    default:
                        if (bitMap[player.y - 1][player.x] && bitMap[player.y][player.x]) moves += 'u';
                        else if (bitMap[player.y + 1][player.x] && bitMap[player.y][player.x]) moves += 'd';
                        else if (bitMap[player.y][player.x - 1] && bitMap[player.y][player.x]) moves += 'l';
                        else if (bitMap[player.y][player.x + 1] && bitMap[player.y][player.x]) moves += 'r';
                }
            }
        }
