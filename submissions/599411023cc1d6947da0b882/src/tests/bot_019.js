			...
			switch ( target.type ) {
				case 'fly':
					...
					*/
					...
					// ловушка
					if (
						screen.is('falling', player.u())		// игрок под камнем
...
//								|| ( screen.is('O*', player.r()) && screen.is('O*', player.r().u()) )
//								|| ( screen.is('O*', player.r()) && screen.is('O*', player.r().d()) )
							) {
								switch ( direction ) {
									case 'u':
										weight += 20;
